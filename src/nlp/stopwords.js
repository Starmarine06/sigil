export const STOPWORDS = new Set(
  (
    ...
    "use,using,used,makes,making,make,need,needs,needed,want,wants,wanted,get,gets,got,go,going," +
    "give,gives,like,just,sure,ok,okay,please,thanks,thank,would,could,should,also,well,one,two," +
    "really,thing,things,way,ways,new,now,will,'ll,'d,im,its,thats,dont,cant,youre,ive,id,hes," +
    "shes,theyre,weve,wel,lets"
  ).split(",")
);